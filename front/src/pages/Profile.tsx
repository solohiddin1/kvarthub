    ...
    <>
      ...
      <div className="pt-6 sm:pt-[60px] pb-30 px-4 sm:px-5">
        ...
        <div className="flex items-center justify-between pt-6 sm:pt-10 pb-5">
          ...
          <Link
            to="#"
            className="text-[#28A453] font-normal flex items-center gap-1 shrink-0 hover:text-[#1e7a34] transition-colors"
          >
            <span>Enter</span>
            <RightOutlined />
          </Link>
        ...
        <ul className="space-y-1">
          ...
          <li>
            <button
              ...
              className="w-full py-[15px] mt-6 bg-linear-to-r from-[#2196F3] to-[#21CBF3] rounded-2xl text-[18px] font-semibold text-white cursor-pointer hover:opacity-90 hover:shadow-lg transition-all duration-300 active:scale-[0.98]"
            >
              My Listings
            </button>
          </li>
